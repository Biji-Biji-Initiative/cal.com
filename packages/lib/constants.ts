...
export const LOGO = process.env.NEXT_PUBLIC_APP_LOGO || "/calcom-logo-white-word.svg";
export const LOGO_DARK = process.env.NEXT_PUBLIC_APP_LOGO_DARK || "/cal-logo-word-black.svg";
export const LOGO_ICON = process.env.NEXT_PUBLIC_APP_LOGO_ICON || "/cal-com-icon-white.svg";
